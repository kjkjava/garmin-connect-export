...
for a in activities_generator:
    ...
    # TODO MM: save gpx/tcx/original file
    # if args.format == 'gpx':
        # data_filename = args.directory + '/activity_' + a['activityId'] + '.gpx'
        # download_url = url_gc_gpx_activity + a['activityId'] + '?full=true'
        # file_mode = 'w'
    # elif args.format == 'tcx':
        # data_filename = args.directory + '/activity_' + a['activityId'] + '.tcx'
        # download_url = url_gc_tcx_activity + a['activityId'] + '?full=true'
        # file_mode = 'w'
    # elif args.format == 'original':
        # data_filename = args.directory + '/activity_' + a['activityId'] + '.zip'
        # fit_filename = args.directory + '/' + a['activityId'] + '.fit'
        # download_url = url_gc_original_activity + a['activityId']
        # file_mode = 'wb'
    # else:
